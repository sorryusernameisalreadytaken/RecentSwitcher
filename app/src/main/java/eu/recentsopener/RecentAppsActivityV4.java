...
/**
 * RecentAppsActivityV4 shows a recents list similar to Variant A but
 * assumes that the app declares the {@code QUERY_ALL_PACKAGES}
 * permission. This may expose additional apps on Android 11+ devices.
 * The core logic mirrors Variant A: it attempts to use aggregated
 * UsageStats first and falls back to events if none are available.
 */
public class RecentAppsActivityV4 extends AppCompatActivity {
    ...
    private void loadRecents() {
        ...
        UsageStatsManager usm = (UsageStatsManager) getSystemService(Context.USAGE_STATS_SERVICE);
        // Attempt aggregated stats first
        ...
        if (stats != null && !stats.isEmpty()) {
            ...
            for (Map.Entry<String, UsageStats> e : entries) {
                ...
                // Do not skip our own package or excluded packages in this variant; let them through
    ...
    private class RecentAppsAdapter extends ArrayAdapter<AppEntry> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (entry != null) {
                ...
                // Highlight excluded packages in red even though we list them
