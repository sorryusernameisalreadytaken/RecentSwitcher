...
public final class DebugHelper {
    ...
    /**
     * Collects usage events and statistics for the last 24 hours and writes
     * them to a file. The report includes the timestamp, event type and
     * package name for each usage event, followed by a summary of aggregated
     * usage stats (package name, lastTimeUsed, totalTimeInForeground).
     * The list of excluded apps and the last/previous packages are also
     * recorded. A toast message is shown indicating where the file was saved.
     *
